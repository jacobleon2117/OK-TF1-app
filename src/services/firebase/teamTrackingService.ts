...
import { collection, doc, setDoc, getDoc, getDocs, query, where, updateDoc, onSnapshot, GeoPoint } from 'firebase/firestore';
...
const getTeamPositionsCollection = (teamId: string) => 
  collection(db, 'teams', teamId, 'positions');
...
export const subscribeToActiveTeams = (
...
export const getTeamsInArea = async (
  center: GeoPoint, 
  radiusInKm: number
): Promise<Team[]> => {
